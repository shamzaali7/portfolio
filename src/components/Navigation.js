                    ...
                    <div className="h-full flex items-center">
                        <Link to="/">
                            <div className="mr-10 flex items-center">
                                ...
                                <h3 className="text-base text-white font-bold tracking-normal leading-tight ml-3 hidden lg:block">Home</h3>
                            </div>
                        </Link>
                        <ul className="pr-12 xl:flex items-center h-full hidden">
                            <Link to="/projects"> 
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-white tracking-normal border-b-2 border-white">Projects</li>
                            </Link>
                            <Link to="/skills">
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-white mx-10 tracking-normal">Skills</li>
                            </Link>
                            <Link to="/resume">
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-white mr-10 tracking-normal">Resume</li>
                            </Link>
                            <Link to="/aboutme">
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-white tracking-normal">About Me</li>
                            </Link>
                        </ul>
                    </div>
                                        ...
                                        <a className="cursor-pointer">
                                            <li className="text-white pt-10">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-indigo-700 xl:text-base text-base ml-3">Projects</p>
                                                </div>
                                            </li>
                                        </a>
                                        <a className="cursor-pointer">
                                            <li className="text-white pt-8">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="text-white xl:text-base  text-base ml-3">Skills</p>
                                                    </div>
                                                </div>
                                            </li>
                                        </a>
                                        <a className="cursor-pointer">
                                            <li className="text-white pt-8">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-white xl:text-base  text-base ml-3">Resume</p>
                                                </div>
                                            </li>
                                        </a>
                                        <li className="text-white pt-8 cursor-pointer">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-white xl:text-base  text-base ml-3">About Me</p>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
