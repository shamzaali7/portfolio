        ...
        <div className="about-me">
            ...
            <div className="container-about-me">
                ...
                <div className="about-des">
                    <div className="about-description mr-6 about-des-box">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;My first introduction to code was when I ennrolled in a computer science course my freshman year of highschool. The main language used was Visual-Basic. My junior year of highschool I took a Java course that persented to me a more commonly used language and the basic concepts that surround it such as if/switch statements, for/while loops, and functions. This helped build my knowledge of perceiving and understanding code at an early stage and was a good segue into higher-level programming.</div>
