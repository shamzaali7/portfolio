        ...
        <div className="skills">
            ...
            <div className="box-skills">
                ...
                <div className="display-skills">
                    ...
                    <p><h6 className="skill-type"><span className="names">PROFICIENCIES</span></h6> Full-Stack Web Development, Front-End Web Development, React, Node.js, Express, MongoDB, NoSQL, SQL, Django, Git, Mocha, Chai, Heroku, Vercel, Fly, Github Pages, Postgres, Database Architecture, Data Structures, Algorithms, Version Control, REST API, Linux/Unix, Optimization, Agile Scrum Team, Data Analysis, Web Scraping</p> 
