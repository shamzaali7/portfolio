                ...
                <div className="last container-des">
                    ...
                    <div className="des about-description">
                        <span className="project-des">
                            ...
                            <p><a className="text-lime-400" href="https://main.d2onbrm7luopll.amplifyapp.com" target="_blank">Front-End Deployed |</a>	<a className="text-lime-400" href="https://github.com/shamzaali7/proshare-frontend" target="_blank">Repository</a></p>
                            <p><a className="text-lime-400" href="https://proshare-backend.herokuapp.com/api/projects" target="_blank">Back-End Deployed |</a> <a className="text-lime-400" href="https://github.com/shamzaali7/proshare-backend" target="_blank">Repository</a></p>
                        </span>
                    </div>
                    <div></div>
                </div>
                ...
                <div className="container-des">
                    ...
                    <div className="des about-description">
                        <span className="project-des">
                            ...
                            <p><a className="text-lime-400" href="https://connection-frontend-api.vercel.app/main" target="_blank">Front-End Deployed |</a><a className="text-lime-400" href="https://github.com/shamzaali7/connection-frontend-api" target="_blank"> Repository</a></p>
                            <p><a className="text-lime-400" href="https://connection-backend-api.herokuapp.com/api/contact" target="_blank">Back-End Deployed |</a> <a className="text-lime-400" href="https://github.com/shamzaali7/connection-backend-api" target="_blank">Repository</a></p>
                        </span>
                    </div>
                    <div></div>
                </div>
                ...
                <div className="last container-des">
                    ...
                    <div className="des about-description">
                        <span className="project-des">
                            ...
                            <p><a className="text-lime-400" href="https://nba-stat-comparison.vercel.app/" target="_blank">Front-End Deployed |</a><a className="text-lime-400" href="https://github.com/shamzaali7/nba-stat-comparison"> Repository</a></p>
                        </span>
                    </div>
                    <div></div>
                </div>
                ...
                <div className="container-des">
                    ...
                    <div className="des about-description">
                        <span className="project-des">
                            ...
                            <p><a className="text-lime-400" href="https://shamzaali7.github.io/spaceman/" target="_blank">Front-End Deployed |</a><a className="text-lime-400" href="https://github.com/shamzaali7/spaceman"> Repository</a></p>
                        </span>
                    </div>
                    <div></div>
                </div>
                <div className="project-pic-four mr-5 mb-5 last">
                    <img src="https://i.imgur.com/36kenBY.png" className="pic" alt="Pic of Spaceman"/>
                </div>
            </div>
            </div>
        </div>
